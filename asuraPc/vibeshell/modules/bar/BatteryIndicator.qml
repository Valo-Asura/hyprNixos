...
Item {
    ...
    StyledRect {
        ...
        Text {
            id: batteryIcon
            anchors.centerIn: parent
            text: Battery.available ? (Battery.isPluggedIn ? Icons.plug : Icons.lightning) : Icons.plug
            ...
            Connections {
                ...
                function onIsPluggedInChanged() {
                    batteryIcon.text = Battery.available ? (Battery.isPluggedIn ? Icons.plug : Icons.lightning) : Icons.plug;
                }
        ...
        StyledToolTip {
            ...
            tooltipText: Battery.available ? ("Battery: " + Math.round(Battery.percentage) + "%" + (Battery.isCharging ? " (Charging)" : "")) : "AC power"
        }
    }
    ...
    BarPopup {
        ...
        contentHeight: (Battery.available ? 64 : 36) + batteryPopup.popupPadding * 2
